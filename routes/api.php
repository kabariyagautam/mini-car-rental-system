...
Route::middleware(['auth:sanctum'])->group(function() {
    ...
    Route::prefix('admin')->middleware('role:admin')->group(function() {
        ...
        Route::post('cars/{car}/approve', [AdminController::class,'approveCar']);
    ...
    Route::prefix('supplier')->middleware('role:supplier')->group(function() {
        ...
        Route::get('cars/{car}', [SupplierCarController::class, 'show'])->name('supplier.cars.show');
        Route::post('cars/{car}', [SupplierCarController::class, 'update'])->name('supplier.cars.update');
        Route::delete('cars/{car}', [SupplierCarController::class, 'destroy'])->name('supplier.cars.destroy');
